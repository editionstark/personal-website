...
function planeShape(strn,diameterORbase,hipotenus,centr,baseangle,hipoangle){
    switch(strn.toUpperCase){
        case("CIRCLE"):
            this.class="CIRCLE";
            this.diameter=diameterORbase;
            this.center=centr;
            this.area=Math.PI*rh*rh;
            break;
        case("TRIANGLE"):
            this.class="TRIANGLE";
            this.basecenter=centr;
            this.base=diameterORbase;
            this.hipotenus=hipotenus;
            this.baseangle=baseangle;
            this.hipotenusangle=hipoangle;
            break;
    }
